...
| Container vs virtual machine — three deployment eras | `04-docker` | [kubernetes.io/docs/concepts/overview](https://kubernetes.io/docs/concepts/overview/) | CC BY 4.0 |
...
All seven are used unmodified and embedded rather than linked, so the decks keep working with no
