...
Most diagrams and every chart in this course were made for it. The four diagrams below come from
...
All four are used unmodified and embedded rather than linked, so the decks keep working with no
network.
